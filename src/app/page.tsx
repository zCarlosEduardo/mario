...
export default function Home() {
  return (
    <html className="scroll-smooth">
      ...
      <NavMenu />
      <main>
        <section id="home" className="h-dvh bg_mario_Luigi_dark flex items-center justify-center">
          <div className="flex justify-center flex-col items-center bottom-0 text-center text-white">
            ...
            <p className="">Mario e Luigi, os encanadores mais confiáveis do Queens, estão aqui para
               ...
               <div className="mt-10 flex flex-row">
                <a href="" style={press2p.style} className="p-4 bg-blue-700  rounded-md m-4"><button>Agende Agora</button></a>
